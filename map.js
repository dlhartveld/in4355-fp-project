...
var Map = function () {
    ...
    $.prototype.force = function (nocache) {
        return nocache ? this.value() : this.forced ? this.value : (this.forced = true, this.value = this.value());
    };
    ...
    var main = new $(function () {
        return _(_($36$)(ready))(_(_($62$$62$$61$)(_(select)(Fay$$list("#start"))))(function ($_a) {
            var start = $_a;
            return _(_($62$$62$$61$)(_(select)(Fay$$list("#stop"))))(function ($_a) {
                var stop = $_a;
                return _(_($62$$62$)(markStopped))(_(_($62$$62$$61$)(_(_($36$)($_return))(_(_($62$$62$)(markStarted))(runJob))))(function ($_a) {
                    var startCompute = $_a;
                    return _(_($36$)(_(setClick)(start)))(startCompute);
                }));
            });
        }));
    });
    var select = function ($_a) {
        return new $(function () {
            return Fay$$jsToFay(["action", [
                ["user", "JQuery", []]
            ]], jQuery(Fay$$fayToJs(["string"], $_a)));
        });
    };
    var ready = function ($_a) {
        return new $(function () {
            return Fay$$jsToFay(["action", [
                ["unknown"]
            ]], jQuery(Fay$$fayToJs(["action", [
                ["unknown"]
            ]], $_a)));
        });
    };
    var setClick = function ($_a) {
        return function ($_b) {
            return new $(function () {
                return Fay$$jsToFay(["action", [
                    ["unknown"]
                ]], Fay$$fayToJs(["user", "JQuery", []], $_a)['click'](Fay$$fayToJs(["action", [
                    ["unknown"]
                ]], $_b)));
            });
        };
    };
    var markStarted = new $(function () {
        return Fay$$jsToFay(["action", [
            ["unknown"]
        ]], jQuery('body').attr('running', 'true'));
    });
    var markStopped = new $(function () {
        return Fay$$jsToFay(["action", [
            ["unknown"]
        ]], jQuery('body').attr('running', 'false'));
    });
    var runJob = new $(function () {
        return Fay$$jsToFay(["action", [
            ["unknown"]
        ]], jQuery.ajax({
            ...
            success: function (data) {
                jQuery('head').append("<script type='text/javascript'>" + data + "</script>")
            },
    ...
    var $_Just = function (slot1) {
        this.slot1 = slot1;
    };
    var Just = function (slot1) {
        return new $(function () {
            return new $_Just(slot1);
        });
    };
    ...
    var show = function ($_a) {
        return new $(function () {
            return Fay$$jsToFay(["string"], JSON.stringify(Fay$$fayToJs(["unknown"], $_a)));
        });
    };
    var fromInteger = function ($_a) {
        return new $(function () {
            var x = $_a;
            return x;
        });
    };
    var fromRational = function ($_a) {
        return new $(function () {
            var x = $_a;
            return x;
        });
            ...
            return function ($_c) {
                return new $(function () {
                    ...
                    return (function ($_ys) {
                        ...
                        var $_$_ys = _($_ys);
                        if ($_$_ys instanceof Fay$$Cons) {
                            var y = $_$_ys.car;
                            var ys$39$ = $_$_ys.cdr;
                            return (function ($tmp) {
                                if (_($tmp) instanceof $_GT) {
                                    return _(_(Fay$$cons)(y))(_(_(_(insertBy)(cmp))(x))(ys$39$));
                                }
                                return _(_(Fay$$cons)(x))(ys);
                            })(_(_(cmp)(x))(y));
                        }
                        return (function () {
                            throw (["unhandled case", $_ys]);
                        })();
                    })(ys);
                });
            };
    ...
    var enumFrom = function ($_a) {
        return new $(function () {
            var i = $_a;
            return _(_(Fay$$cons)(i))(_(enumFrom)(_(i) + 1));
        });
    };
    var enumFromTo = function ($_a) {
        return function ($_b) {
            return new $(function () {
                var n = $_b;
                var i = $_a;
    ...
    var zipWith = function ($_a) {
        return function ($_b) {
            return function ($_c) {
                return new $(function () {
                    var $_$_c = _($_c);
                    if ($_$_c instanceof Fay$$Cons) {
                        var b = $_$_c.car;
                        var bs = $_$_c.cdr;
                        var $_$_b = _($_b);
                        if ($_$_b instanceof Fay$$Cons) {
    ...
    var maybe = function ($_a) {
        return function ($_b) {
            return function ($_c) {
                return new $(function () {
                    if (_($_c) instanceof $_Nothing) {
                        var m = $_a;
                        return m;
                    }
                    if (_($_c) instanceof $_Just) {
                        var x = _($_c).slot1;
                        var f = $_b;
                        return _(f)(x);
                    }
    ...
    var concat = new $(function () {
        return _(_(foldr)(conc))(null);
    });
    var foldr = function ($_a) {
        return function ($_b) {
            return function ($_c) {
                return new $(function () {
                    if (_($_c) === null) {
    ...
    var forM_ = function ($_a) {
        return function ($_b) {
            return new $(function () {
                ...
                if (_($_a) === null) {
                    return _($_return)(Fay$$unit);
                }
                throw ["unhandled case in Ident \"forM_\"", [$_a, $_b]];
            });
        };
    };
    var mapM_ = function ($_a) {
        return function ($_b) {
            return new $(function () {
                var $_$_b = _($_b);
                if ($_$_b instanceof Fay$$Cons) {
    ...
    var mod = function ($_a) {
        return function ($_b) {
            return new $(function () {
                return Fay$$jsToFay(["double"], Fay$$fayToJs(["double"], $_a) % Fay$$fayToJs(["double"], $_b));
            });
        };
    };
    var min = function ($_a) {
        return function ($_b) {
            return new $(function () {
                return Fay$$jsToFay(["double"], Math.min(Fay$$fayToJs(["double"], $_a), Fay$$fayToJs(["double"], $_b)));
            });
        };
    };
    var max = function ($_a) {
        return function ($_b) {
            return new $(function () {
                return Fay$$jsToFay(["double"], Math.max(Fay$$fayToJs(["double"], $_a), Fay$$fayToJs(["double"], $_b)));
            });
        };
    };
    var Fay$$fayToJsUserDefined = function (type, obj) {
        var _obj = _(obj);
        var argTypes = type[2];
        if (_obj instanceof $_EQ) {
            return {
                "instance": "EQ"
            };
        }
        if (_obj instanceof $_LT) {
            return {
                "instance": "LT"
            };
        }
        if (_obj instanceof $_GT) {
            return {
                "instance": "GT"
            };
        }
        if (_obj instanceof $_Nothing) {
            return {
                "instance": "Nothing"
            };
        }
        if (_obj instanceof $_Just) {
            return {
                "instance": "Just",
    ...
    var Fay$$jsToFayUserDefined = function (type, obj) {
        ...
        if (obj["instance"] === "Just") {
            return new $_Just(Fay$$jsToFay(["unknown"], obj["slot1"]));
        }
        return obj;
    };
    // Exports
